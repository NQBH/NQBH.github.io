...
- **Book/Novel -- Sách/Tiểu Thuyết.** [***Some Thoughts on Learning, Teaching, & Research: A Short Novel -- Vài Suy Nghĩ Về Việc Học, Việc Dạy, & Nghề Nghiên Cứu: 1 Tiểu Thuyết Ngắn***](https://github.com/NQBH/advanced_STEM_beyond/blob/main/learning_teaching_research/NQBH_on_learning_teaching_research.pdf). [[TeX](https://github.com/NQBH/advanced_STEM_beyond/blob/main/learning_teaching_research/NQBH_on_learning_teaching_research.tex)] `...`
  ...
  + [*Comments, Contributors, & Payments/Donations -- Bình Luận, Đóng Góp, & Thanh Toán/Quyên Góp*](https://github.com/NQBH/advanced_STEM_beyond/blob/main/learning_teaching_research/comment_donation/NQBH_learning_teaching_research_comment_donation.pdf). [[TeX](https://github.com/NQBH/advanced_STEM_beyond/blob/main/learning_teaching_research/comment_donation/NQBH_learning_teaching_research_comment_donation.tex)].
...
- [*On Teaching Rules & Principles -- Bàn Về Các Quy Tắc & Nguyên Tắc Giảng Dạy*](https://github.com/NQBH/advanced_STEM_beyond/blob/main/teach/rule_principle/NQBH_teaching_rule_principle.pdf). [[TeX](https://github.com/NQBH/advanced_STEM_beyond/blob/main/teach/rule_principle/NQBH_teaching_rule_principle.tex)]. Bàn về các quy tắc & nguyên tắc trong việc học, việc dạy, & nghiên cứu STEM nâng cao ở bậc Đại Học trở lên, gồm undergraduate- & graduate levels.
	+ Python code for general grading: [[`grade.py`](https://github.com/NQBH/advanced_STEM_beyond/blob/main/teach/rule_principle/grade.py)]. Python code for specific grading: [[`VNTA_score.py`](https://github.com/NQBH/advanced_STEM_beyond/blob/main/teach/student/VNTA_score.py)].
	...
	+ Recommendation Letter: [recommendation letter for NQBH](https://github.com/NQBH/publication/tree/master/recommendation_letter). [recommendation letter template](https://github.com/NQBH/advanced_STEM_beyond/blob/main/teach/recommendation_letter/NQBH_recommendation_letter_template.pdf). [[TeX](https://github.com/NQBH/advanced_STEM_beyond/blob/main/teach/recommendation_letter/NQBH_recommendation_letter_template.tex)]. [recommendation letter PVT](https://github.com/NQBH/advanced_STEM_beyond/blob/main/teach/recommendation_letter/PVT/NQBH_recommendation_letter_PVT.pdf). [[TeX](https://github.com/NQBH/advanced_STEM_beyond/blob/main/teach/recommendation_letter/PVT/NQBH_recommendation_letter_PVT.tex)].
...
- **Linear Algebra & Abstract Algebra**.
  ...
  + [`C++4LA`]. [[`Python4LA`](https://github.com/NQBH/advanced_STEM_beyond/tree/main/algebra/Python)].
- **Mathematical Analysis & Numerical Analysis -- Giải Tích Toán Học & Giải Tích Số**.
  + [*Survey: Mathematical Analysis & Numerical Analysis -- Khảo Sát: Giải Tích Toán Học & Giải Tích Số*](https://github.com/NQBH/advanced_STEM_beyond/blob/main/analysis/NQBH_mathematical_analysis.pdf). [[TeX](https://github.com/NQBH/advanced_STEM_beyond/blob/main/analysis/NQBH_mathematical_analysis.tex)].
  ...
  + Codes: [[`C++4MA`](https://github.com/NQBH/advanced_STEM_beyond/tree/main/analysis/C++)]. [[`Python4MA`](https://github.com/NQBH/advanced_STEM_beyond/tree/main/analysis/Python)].
- [***Vietnamese Mathematical Olympiad for High School- & College Students (VMC) -- Olympic Toán Học Học Sinh & Sinh Viên Toàn Quốc***](https://github.com/NQBH/advanced_STEM_beyond/blob/main/VMC/NQBH_VMC.pdf). [[TeX](https://github.com/NQBH/advanced_STEM_beyond/blob/main/VMC/NQBH_VMC.tex).]
	+ Codes: [[`C++4VMC`](https://github.com/NQBH/advanced_STEM_beyond/tree/main/VMC++)]. [[`Python4VMC`](https://github.com/NQBH/advanced_STEM_beyond/tree/main/VMC/Python)]. [[`pictures`](https://github.com/NQBH/advanced_STEM_beyond/tree/main/VMC/figure)]. [[`resource`](https://github.com/NQBH/advanced_STEM_beyond/tree/main/VMC/resource)].
- **Discrete Mathematics -- Toán Rời Rạc**.
	+ [*Survey: Discrete Mathematics -- Khảo Sát: Toán Rời Rạc*](https://github.com/NQBH/advanced_STEM_beyond/blob/main/discrete_mathematics/NQBH_discrete_mathematics.pdf). [[TeX](https://github.com/NQBH/advanced_STEM_beyond/blob/main/discrete_mathematics/NQBH_discrete_mathematics.tex)].
	...
	+ Codes: [`C++4DM`]. [[`Python4DM`]()].
- **Combinatorics & Graph Theory -- Tổ Hợp & Lý Thuyết Đồ Thị**.
	+ [*Survey: Combinatorics & Graph Theory -- Khảo Sát: Tổ Hợp & Lý Thuyết Đồ Thị*](https://github.com/NQBH/advanced_STEM_beyond/blob/main/combinatorics/NQBH_combinatorics.pdf). [[TeX](https://github.com/NQBH/advanced_STEM_beyond/blob/main/combinatorics/NQBH_combinatorics.tex)].
	...
	+ [*Course Project: Combinatorics & Graph Theory -- Đồ Án Môn Học: Tổ Hợp & Lý Thuyết Đồ Thị*](https://github.com/NQBH/advanced_STEM_beyond/blob/main/combinatorics/project/NQBH_combinatorics_graph_theory_project.pdf). [[TeX](https://github.com/NQBH/advanced_STEM_beyond/blob/main/combinatorics/project/NQBH_combinatorics_graph_theory_project.tex)].
	+ Codes: [[`C++4C&GT`](https://github.com/NQBH/advanced_STEM_beyond/blob/main/combinatorics/C++)]. [[`Python4C&GT`](https://github.com/NQBH/advanced_STEM_beyond/blob/main/combinatorics/Python)].
	+ Exams: [midterm exam Summer 2025](https://github.com/NQBH/advanced_STEM_beyond/blob/main/combinatorics/resource/combinatorics_graph_theory_midterm_exam_2025/NQBH_combinatorics_graph_theory_midterm_exam_2025.pdf). [[TeX](https://github.com/NQBH/advanced_STEM_beyond/blob/main/combinatorics/resource/combinatorics_graph_theory_midterm_exam_2025/NQBH_combinatorics_graph_theory_midterm_exam_2025.tex)]. [midterm exam Summer 2025 solution](https://github.com/NQBH/advanced_STEM_beyond/blob/main/combinatorics/resource/combinatorics_graph_theory_midterm_exam_2025/NQBH_combinatorics_graph_theory_midterm_exam_solution_2025.pdf). [[TeX](https://github.com/NQBH/advanced_STEM_beyond/blob/main/combinatorics/resource/combinatorics_graph_theory_midterm_exam_2025/NQBH_combinatorics_graph_theory_midterm_exam_solution_2025.tex)].
	+ Resources: [[resource](https://github.com/NQBH/advanced_STEM_beyond/tree/main/combinatorics/resource)]. [[grade](https://github.com/NQBH/advanced_STEM_beyond/tree/main/combinatorics/grade)].
- **Probability & Statistics -- Xác Suất & Thống Kê**.
	+ [*Survey: Probability & Statistics -- Khảo Sát: Xác Suất & Thống Kê*](https://github.com/NQBH/advanced_STEM_beyond/blob/main/probability_statistics/NQBH_probability_statistics.pdf). [[TeX](https://github.com/NQBH/advanced_STEM_beyond/blob/main/probability_statistics/NQBH_probability_statistics.tex)]
	+ Lecture: [*Lecture Note: Probability Theory & Statistics Theory -- Bài Giảng: Lý Thuyết Xác Suất & Lý Thuyết Thống Kê*](https://github.com/NQBH/advanced_STEM_beyond/blob/main/probability_statistics/lecture/NQBH_probability_statistics_lecture.pdf).
	+ Codes: [`C++4P&S`]. [`Python4P&S`].
- **Data Science -- Khoa Học Dữ Liệu**.
	+ [*Survey: Data Science -- Khảo Sát: Khoa Học Dữ Liệu*](https://github.com/NQBH/advanced_STEM_beyond/blob/main/data_science/NQBH_data_science.pdf). [[TeX](https://github.com/NQBH/advanced_STEM_beyond/blob/main/data_science/NQBH_data_science.tex)].
	+ Slide: [*Mathematics For Data Science -- Phương Pháp Toán cho Khoa Học Dữ Liệu*](https://github.com/NQBH/advanced_STEM_beyond/blob/main/data_science/slide/NQBH_mathematical_methods_for_DS_slide.pdf). [[TeX](https://github.com/NQBH/advanced_STEM_beyond/blob/main/data_science/slide/NQBH_mathematical_methods_for_DS_slide.tex)].
	+ Lecture Note: [*Lecture Note: Mathematics For Data Science -- Bài Giảng: Phương Pháp Toán cho Khoa Học Dữ Liệu*](https://github.com/NQBH/advanced_STEM_beyond/blob/main/data_science/slide/NQBH_mathematical_methods_for_DS_slide.pdf). [[TeX](https://github.com/NQBH/advanced_STEM_beyond/blob/main/data_science/slide/NQBH_mathematical_methods_for_DS_slide.tex)].
	+ Codes: [`C++4DS`]. [[`Python4DS`](https://github.com/NQBH/advanced_STEM_beyond/tree/main/data_science/Python)].
- **Machine Learning -- Học Máy**.
	+ [*Survey: Machine Learning -- Khảo Sát: Học Máy*](https://github.com/NQBH/draft/blob/master/machine_learning/NQBH_machine_learning.pdf). [[TeX](https://github.com/NQBH/draft/blob/master/machine_learning/NQBH_machine_learning.tex)].
	...
	+ Codes: [`C++4ML`]. [[`Python4ML`](https://github.com/NQBH/advanced_STEM_beyond/tree/main/machine_learning/Python)].
- **Deep Learning -- Học Sâu**.
	+ [*Survey: Deep Learning -- Khảo Sát: Học Sâu*](https://github.com/NQBH/advanced_STEM_beyond/blob/main/deep_learning/NQBH_deep_learning.pdf). [[TeX](https://github.com/NQBH/advanced_STEM_beyond/blob/main/deep_learning/NQBH_deep_learning.tex)].
	+ Slide: [*Mathematics For Deep Learning -- Phương Pháp Toán cho Học Sâu*]
	+ Lecture: [*Lecture Note: Mathematics For Deep Learning -- Bài Giảng: Phương Pháp Toán cho Học Sâu*]
	+ Codes: [`C++4DL`]. [[`Python4DL`](https://github.com/NQBH/advanced_STEM_beyond/tree/main/deep_learning/Python)].
- **Mathematical Optimization -- Toán Tối Ưu**.
	+ [*Survey: Mathematical Optimization -- Khảo Sát: Toán Tối Ưu*](https://github.com/NQBH/advanced_STEM_beyond/blob/main/optimization/NQBH_mathematical_optimization.pdf). [[TeX](https://github.com/NQBH/advanced_STEM_beyond/blob/main/optimization/NQBH_mathematical_optimization.tex)].
- **Number Theory -- Lý Thuyết Số**.
	+ [*Survey: Number Theory -- Khảo Sát: Lý Thuyết Số*](https://github.com/NQBH/advanced_STEM_beyond/blob/main/number_theory/NQBH_number_theory.pdf). [[TeX](https://github.com/NQBH/advanced_STEM_beyond/blob/main/number_theory/NQBH_number_theory.tex)].
- **Large Language Models (LLMs) -- Mô Hình Ngôn Ngữ Lớn**.
	+ [*Survey: Large Language Models (LLMs) -- Khảo Sát: Mô Hình Ngôn Ngữ Lớn*](https://github.com/NQBH/advanced_STEM_beyond/blob/main/large_language_model/NQBH_large_language_model.pdf). [[TeX](https://github.com/NQBH/advanced_STEM_beyond/blob/main/large_language_model/NQBH_large_language_model.tex)].
	+ Slide: [*Slide: Mathematics For Large Language Models -- Slide Bài Giảng: Toán Học Cho Mô Hình Ngôn Ngữ Lớn*]
	+ Lecture: [*Lecture Note: Mathematics For Large Language Models -- Bài Giảng: Toán Học Cho Mô Hình Ngôn Ngữ Lớn*]
...
- **Competitive Programming & ICPC -- Lập Trình Thi Đấu: Olympic Tin Học (OLP), Olympic Trí Tuệ Nhân Tạo (OAI), & ICPC.**
	...
	+ [*Disjoint Set Union (DSU) -- Hợp Tập Hợp Rời Rạc*](https://github.com/NQBH/advanced_STEM_beyond/blob/main/OLP_ICPC/disjoint_set_union/NQBH_disjoint_set_union.pdf). [[TeX](https://github.com/NQBH/advanced_STEM_beyond/blob/main/OLP_ICPC/disjoint_set_union/NQBH_disjoint_set_union.tex)].
...
- **Data Structure & Algorithms (DSA) -- Cấu Trúc Dữ Liệu & Giải  Thuật (DSA)**.
	...
	+ [*Lecture Note: Data Structure & Algorithms (DSA) -- Bài Giảng: Cấu Trúc Dữ Liệu & Giải  Thuật (DSA)*](https://github.com/NQBH/advanced_STEM_beyond/blob/main/data_structure_algorithm/lecture/NQBH_data_structure_algorithm_lecture.pdf). [[TeX](https://github.com/NQBH/advanced_STEM_beyond/blob/main/data_structure_algorithm/lecture/NQBH_data_structure_algorithm_lecture.tex)].
	+ Codes: [[`C++4DSA`]]. [[`Python4DSA`]].
- **Information Technology Fundamentals -- Nền Tảng Công Nghệ Thông Tin**.
	+ [*Survey: Information Technology Fundamentals -- Khảo Sát: Nền Tảng Công Nghệ Thông Tin*].
	+ [*Lecture Note: Information Technology Fundamentals -- Bài Giảng: Nền Tảng Công Nghệ Thông Tin*](https://github.com/NQBH/advanced_STEM_beyond/blob/main/IT_fundamentals/lecture/NQBH_IT_fundamentals_lecture.pdf). [[TeX](https://github.com/NQBH/advanced_STEM_beyond/blob/main/IT_fundamentals/lecture/NQBH_IT_fundamentals_lecture.pdf)]. Focused on basic Python programming language.
	+ [midterm exam summer 2025](https://github.com/NQBH/advanced_STEM_beyond/blob/main/IT_fundamentals/resource/IFT2_midterm_exam_2025/NQBH_ITF2_midterm_exam_2025.pdf). [[TeX](https://github.com/NQBH/advanced_STEM_beyond/blob/main/IT_fundamentals/resource/IFT2_midterm_exam_2025/NQBH_ITF2_midterm_exam_2025.tex)]. [midterm exam summer 2025 solution](https://github.com/NQBH/advanced_STEM_beyond/blob/main/IT_fundamentals/resource/IFT2_midterm_exam_2025/NQBH_ITF2_midterm_exam_2025_solution.pdf). [[TeX](https://github.com/NQBH/advanced_STEM_beyond/blob/main/IT_fundamentals/resource/IFT2_midterm_exam_2025/NQBH_ITF2_midterm_exam_2025_solution.tex)].
	+ Codes: [`C++4IFT2`](https://github.com/NQBH/advanced_STEM_beyond/tree/main/IT_fundamentals/C++). [`Python4IFT2`](https://github.com/NQBH/advanced_STEM_beyond/tree/main/IT_fundamentals/Python).
- **Discrete Mathematics -- Toán Rời Rạc**.
	+ [*Survey: Discrete Mathematics -- Khảo Sát: Toán Rời Rạc*](https://github.com/NQBH/advanced_STEM_beyond/blob/main/discrete_mathematics/NQBH_discrete_mathematics.pdf). [[TeX](https://github.com/NQBH/advanced_STEM_beyond/blob/main/discrete_mathematics/NQBH_discrete_mathematics.tex)].
	+ Slide: [*Discrete Mathematics for Computer Science (DM4CS) -- Toán Rời Rạc Cho Khoa Học Máy Tính*](https://github.com/NQBH/advanced_STEM_beyond/blob/main/discrete_mathematics/slide/NQBH_discrete_mathematics_slide.pdf). [[TeX](https://github.com/NQBH/advanced_STEM_beyond/blob/main/discrete_mathematics/slide/NQBH_discrete_mathematics_slide.tex)]. *Note*: `DM here is the abbreviation of Discrete Mathematics, not a curse or 1 of common Vietnamese profanities.`
	+ Lecture: [*Lecture Note: Discrete Mathematics for Computer Science -- Bài Giảng: Toán Rời Rạc Cho Khoa Học Máy Tính*](https://github.com/NQBH/advanced_STEM_beyond/blob/main/discrete_mathematics/lecture/NQBH_discrete_mathematics_lecture.pdf). [[TeX](https://github.com/NQBH/advanced_STEM_beyond/blob/main/discrete_mathematics/lecture/NQBH_discrete_mathematics_lecture.tex)].
	+ Codes: [`C++4DM`]. [`Python4DM`].
- **Data Science -- Khoa Học Dữ Liệu**.
	+ [*Survey: Data Science -- Khảo Sát: Khoa Học Dữ Liệu*](https://github.com/NQBH/advanced_STEM_beyond/blob/main/data_science/NQBH_data_science.pdf). [[TeX](https://github.com/NQBH/advanced_STEM_beyond/blob/main/data_science/NQBH_data_science.tex)].
...
- **Large Language Models (LLMs) -- Mô Hình Ngôn Ngữ Lớn**.
	+ [*Survey: Large Language Models (LLMs) -- Khảo Sát: Mô Hình Ngôn Ngữ Lớn*](https://github.com/NQBH/advanced_STEM_beyond/blob/main/large_language_model/NQBH_large_language_model.pdf). [[TeX](https://github.com/NQBH/advanced_STEM_beyond/blob/main/large_language_model/NQBH_large_language_model.tex)].
	+ Slide: [*Slide: Mathematics For Large Language Models -- Slide Bài Giảng: Toán Học Cho Mô Hình Ngôn Ngữ Lớn*]
	+ Lecture: [*Lecture Note: Mathematics For Large Language Models -- Bài Giảng: Toán Học Cho Mô Hình Ngôn Ngữ Lớn*](https://github.com/NQBH/advanced_STEM_beyond/blob/main/large_language_model/lecture/NQBH_large_language_model_lecture.pdf). [[TeX](https://github.com/NQBH/advanced_STEM_beyond/blob/main/large_language_model/lecture/NQBH_large_language_model_lecture.pdf)].
	+ Codes: [[`C++4LLM`](https://github.com/NQBH/advanced_STEM_beyond/tree/main/large_language_model/C++)]. [[`Python4LLM`](https://github.com/NQBH/advanced_STEM_beyond/tree/main/large_language_model/Python)].
- **Computer Music -- Âm Nhạc Máy Tính**.
	...
	+ Lecture:
	+ Codes: [[`C++4CMus`]] [[`Python4CMus`](https://github.com/NQBH/advanced_STEM_beyond/tree/main/computer_music/Python)].
