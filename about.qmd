...
image: "files/images/NQBH.jpg"
page-navigation: true
toc: true
sidebar: true
page-layout: article # Changed from 'full' to 'article' to center the page and give it margins

about:
  id: hero-heading
  template: trestles # Change 'trestles' to 'jolla' if you want your photo and links centered on the screen
  image-width: 15em
  links:
    - icon: github
      text: GitHub
      href: https://github.com/NQBH
      target: _blank
    - icon: globe
      text: Uprofile
    ...
    - icon: envelope
      text: E-mail
      href: mailto:nguyenquanbahong@gmail.com
    - icon: linkedin
      text: LinkedIn
    ...
    - text: "{{< ai google-scholar >}} Google Scholar"
      href: https://scholar.google.com/citations?user=22hHvB8AAAAJ&hl=vi
      target: _blank
    - text: "{{< ai researchgate >}} Research Gate"
      href: https://www.researchgate.net/profile/Hong-Nguyen-184
      target: _blank
...
>
> [fr] Ce court roman est constitué de quelques morceaux de mes écrits, qui peuvent être partagés. Je suis prêt à partager, afin d'aiguiser mes flux de pensées, d'équilibrer mon travail scientifique via diverses formes esthétiques, de suivre psychologiquement et mentalement mes transitions de l'enfance à l'âge adulte s'il y en a.  
>
> [de] Dieser Kurzroman besteht aus einigen Teilen meines Schreibens, die geteilt werden können & Ich bin bereit, sie zu teilen, um meine Gedankenflüsse zu schärfen, meine wissenschaftliche Arbeit durch verschiedene ästhetische Formen auszubalancieren, & um meine Übergänge vom Jungen- zum Mannesalter psychologisch und mental zu verfolgen, falls es welche gibt.
...
(The double *"ss"* in the end of Weierstrass's name should be the character ß, i.e., beta-like symbol: Eszett, in his original name in German. Trust me: I knew it since I worked at Weierstrass Institute in Berlin, Germany for 1.5 years.)
